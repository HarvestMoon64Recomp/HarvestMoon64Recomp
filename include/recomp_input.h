...
namespace recomp {
    ...
    DEFINE_INPUT(A, 0x8000, "Interact") \
    DEFINE_INPUT(B, 0x4000, "Use Tool") \
    DEFINE_INPUT(Z, 0x2000, "Item Info") \
    DEFINE_INPUT(R, 0x0010, "Camera Right") \
    DEFINE_INPUT(START, 0x1000, "Menu") \
    DEFINE_INPUT(C_UP, 0x0008, "Put in Rucksack") \
    DEFINE_INPUT(C_LEFT, 0x0002, "Whistle Horse") \
    DEFINE_INPUT(C_DOWN, 0x0004, "Eat Held Item") \
    DEFINE_INPUT(C_RIGHT, 0x0001, "Whistle Dog") \
    ...
    DEFINE_INPUT(L, 0x0020, "Camera Left")
